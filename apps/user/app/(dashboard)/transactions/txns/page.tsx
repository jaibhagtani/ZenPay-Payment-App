    ...
    return (
        <div>
            <div className="max-w-screen">
                <div className="text-3xl bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 inline-block text-transparent bg-clip-text pt-8 mb-8 font-bold px-4 mt-12">
                    Recent Transactions
                </div>
